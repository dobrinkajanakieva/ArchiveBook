...
namespace DAL.EFTests
{
	public class DocumentScanTest
	{
        ...
        public void UpdateDocumentByID()
        {
            ...
            //Act
            DocumentScan document = new DocumentScan(100, ID_ArchiveBooking, DocumentPath);
            documentScanEngine.UpdateDocumentScanByID(25, document);
            document = documentScanEngine.GetDocumentByID(25);
        ...
        public void DeleteDocumentByArchiveBooking()
        {
            ...
            //Act
            documentScanEngine.DeleteDocumentByArchiveBooking(73);
        ...
        public void InsertDocuments()
        {
            ...
            const int ID_ArchiveBooking2 = 88;
